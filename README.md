...
**WIWI Widget** - A terminal-callable desktop widget that provides unified access to ChatGPT, Claude, and Perplexity without needing individual API keys or subscriptions.
...
- 📝 **Conversation History**: Track and review your conversations
- 🧹 **Clear History**: Easily wipe conversation data
- 💻 **Cross-Platform**: Works on Windows, macOS, and Linux
- 🐳 **Docker Ready**: Containerized for easy deployment
- 💡 **Portfolio Quality**: Clean, understandable code showcasing good architecture
...
Once the widget is running, you can use these slash commands:
...
2. Switch to your preferred service: `/claude`
3. Login if needed: `/login` (complete login in the popped-up window)
4. Start chatting: Type your questions directly
...
2. When you type a query, it's sent to the active service's browser
...
- The widget doesn't modify or intercept your communications with the services

## Customization

For developers looking to extend or modify the widget:

- Add new services by extending the service lists in browser_handler.py and login_manager.py
...
- Python 3.9+
- PySide6 6.5.0+
- System libraries for QtWebEngine (see Dockerfile for details)
...
Built with PySide6 and inspired by the desire to make AI services more accessible without managing multiple subscriptions or API keys.

---

**Note**: This implementation uses simulated responses for demonstration purposes. For a production version, actual web scraping or official APIs would be implemented with proper respect to terms of service and rate limits.